...
class CG(object):
    ...
    sExtractCmdTemplate = 'python extractvalues.py --header {sFamilyDir}/{sSpecificDir}/log/{sShelfLogFileName}.log > {sFamilyDir}/{sSpecificDir}/ext/{sShelfLogFileName}.ext'
    sCleanupCmdTemplate = 'python datacleanup.py {sFamilyDir}/{sSpecificDir}/ext/{sShelfLogFileName}.ext {sFamilyDir}/{sSpecificDir}/dat'

    lTemplates = [sShelfRunCmdTemplate, sExtractCmdTemplate, sCleanupCmdTemplate]
    lCommands = []
