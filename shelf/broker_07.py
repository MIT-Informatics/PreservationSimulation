...
def fnGetCommandTemplates(mysCommandFilename):
    '''
    Read (interesting) lines from exteran file as command templates
...
class CDatabase(object):
    ...
    def fnbIsItDone(self,mysInstructionId):
        ...
        NTRC.ntracef(3,"DB","proc main donelist id|%s| list|%s|" % (mysInstructionId, lMaybeDone))
