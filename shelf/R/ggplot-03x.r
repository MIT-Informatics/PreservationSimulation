...
makeplot <- function(ncopies,cdata,titlelines,a0x,a0y,ayx,ayy,aqx,aqy) 
{
    ...
    if (ncopies > 1)
    {
        p <- p+guide_legend(title="This is a legend", label=TRUE ) 
    }
