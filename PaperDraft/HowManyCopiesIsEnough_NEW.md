...
The table of **Exhibit nnn** shows the expected rates of document errors, theoretical and simulated, as a calibration check, over a wide range of storage error rates.  [[calibration for ncopies=1 in shelf/docs/PoissonFailures.xls]]

![Exhibit nnn: Poisson Failures for copies=1 -- !!!REDO TO INCLUDE ONLY ESSENTIALS!!!](../pictures/copies1/PoissonFailures.png)
