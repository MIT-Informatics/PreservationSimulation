<html>
    <!-- mainsim_form.tpl - template for bottle to present options
        for a single run of PreservationSimulation/shelf/main.py -->
<body>
<form action="mainsim" method="post">
    <font size="+1">
        ...
        <p><h3>Choose options for a <em>single</em> simulation run</h3></p>
