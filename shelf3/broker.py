...
from . import  searchdatabase
from . import  searchdatabasemongo
from . import  util
from . import  brokercli
from . import  command
import  copy
from . import  brokerformat
from . import  brokergetcores
...
def fnbWaitForOpening(mynProcessMax, mysProcessName, mynWaitTime, mynWaitLimit):
    ...
    for idx in range(mynWaitLimit):
        ...
        NTRC.ntracef(3,"WAIT","proc WaitForOpening1 idx|%d| cmd|%s| result|%s|" 
        ...
        NTRC.ntracef(3,"WAIT","proc WaitForOpening2 sleep and do again idx|%d| nResult|%d|" 
            % (idx, nResult))
...
def main():
    ...
    NTRC.ntracef(0,"MAIN","proc querydict2|%s|" % ((dQuery)))
        ...
        if bContinue:
            ...
            with open(g.sActorCmdFileName, 'w') as fhActorCmdFile:
                ...
                for sCommand in g.lCommands:
                    print(g.cFmt.fnsMaybeTest(sCommand, g), file=fhActorCmdFile)
            ...
            NTRC.ntracef(0, "MAIN", "OOPS, Stuck!  Too many python "
