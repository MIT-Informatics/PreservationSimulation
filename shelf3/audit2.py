...
# C A u d i t 2 . m A u d i t C o l l e c t i o n 
    ...
    def mAuditCollection(self, mynCycleInterval, mynSegments, mysCollectionID, 
        ...
        for iThisSegment in range(mynSegments):
            ...
            NTRC.ntracef(3, "AUD2", "proc AuditCollection1 now|%s| tstart|%s| "
        ...
        with cClient.NetworkBandwidthResource.request() as reqnetwork:
            ...
            for sServerID in cCollection.lServerIDs:
                ...
                for sDocID in self.lDocsThisSegment:
                    ...
                    ###if okay
                    if fTransferTime:
                        NTRC.ntracef(3, "AUD2", "proc AuditSegment3 retrieve "
                        ...
                        if self.mIsDocumentLost(sDocID):
                            ...
                            NTRC.ntracef(5, "AUD2", "proc AuditSegment2 doc|%s| "
                                "svr|%s| lost on|%s|" 
                                % (sDocID, sServerID, 
            ...
            for sDocID in sorted(list(self.dlDocsDamagedOnServers.keys()), 
                ...
                NTRC.ntracef(3, "AUD2", "proc AuditSegment1 doc|%s| nsvr|%s| "
                    "loston|%s| nleft|%s|" 
                ...
                for sServerID in lDocLostOnServers:
                    if nCopiesLeft > 0:
                        ...
                        if fTransferTime == False:
                            ...
                            ###log repair effected
                            NTRC.ntracef(3, "AUD2", "proc AuditSegment4 repair "
...
# 20180531  RBL Update to use only ntrace, ntracef, NTRC.
