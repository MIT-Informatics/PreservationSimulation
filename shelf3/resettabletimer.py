...
if 1:
    ...
    def callback(timerobj, context):
        NTRC.ntrace(0,"callback %s delay %s called from %s at %s." 
    ...
    def interrupt(timerobj, context):
        NTRC.ntrace(0,"interrupt %s delay %s called from %s at %s." 
            % (context, timerobj.delay, timerobj, env.now))
        return (timerobj, context)
    ...
    def starter4e(env, event):
        NTRC.ntrace(3,"4e.starter4e: before callstart at %s." % env.now)
        event.start()
        NTRC.ntrace(3,"4e.starter4e: before yieldtimeout at %s." % env.now)
        yield env.timeout(3)
        NTRC.ntrace(3,"4e.starter4e: after yieldtimeout at %s." % env.now)
        event.reset()
        NTRC.ntrace(3,"4e.starter4e: after callreset at %s." % env.now)

    @ntrace
    def starter4f(env, event):
        NTRC.ntrace(3,"4f.starter4f: before callstart at %s." % env.now)
        event.start()
        NTRC.ntrace(3,"4f.starter4f: before yieldtimeout at %s." % env.now)
        yield env.timeout(5)
        NTRC.ntrace(3,"4f.starter4f: after yieldtimeout at %s." % env.now)
        event.stop()
        event.start()
        NTRC.ntrace(3,"4f.starter4f: after stop/start at %s." % env.now)

    @ntrace
    def starter4g(env, event):
        NTRC.ntrace(3,"4g.starter4g: before callstart at %s." % env.now)
        event.start()
        NTRC.ntrace(3,"4g.starter4g: before yieldtimeout at %s." % env.now)
        yield env.timeout(5)
        NTRC.ntrace(3,"4g.starter4g: after yieldtimeout at %s." % env.now)
        event.stop()
        ...
        yield env.timeout(1)
        event.reset()
        NTRC.ntrace(3,"4g.starter4g: after change delay and reset twice at %s." % env.now)

    @ntrace
    def starter4h(env, event):
        NTRC.ntrace(3,"4h.starter4h: before callstart at %s." % env.now)
        event.start()
        NTRC.ntrace(3,"4h.starter4h: before yieldtimeout at %s." % env.now)
        yield env.timeout(23)
        NTRC.ntrace(3,"4h.starter4h: after yieldtimeout at %s." % env.now)
        event.reset()
        NTRC.ntrace(3,"4h.starter4h: after reset at %s." % env.now)
        yield event.event
        NTRC.ntrace(3,"4h.starter4h: after yieldevent at %s." % env.now)
        NTRC.ntrace(0,"yieldevent %s completed at %s." % (event.context,env.now))

    # M a i n
    if __name__ == '__main__':
        NTRC.ntrace(3,"4.Begin.")
        ...
        NTRC.ntrace(0,"4.Starting simulation.")
        ...
        env.run(1000)
        NTRC.ntrace(0,"4.End of simulation.")
