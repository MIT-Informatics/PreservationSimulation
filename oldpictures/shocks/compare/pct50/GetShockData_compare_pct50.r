# GetShockData_compare_pct50.r
#                                       RBLandau 20171230
# where to run?
# setwd("C:/cygwin64/home/landau/working/PreservationSimulation/shocks/compare/pct50")
# 
# For copies=3,4,5, what are the failure rates at shock impact 50%?
# 
...
if (nrow(dat.shockall) > 0)
{
    ...
    gp <- fnPlotShock1(dat.shockspan2, nFreq=2, nDuration=12, nSpan=2, nImpact=50)
    plot(gp)
    fnPlotMakeFile(gp, "Shock_compare_copvar_freq2yr_dur1yr_span2_impact50.png")
    ...
    plot(gp)
    fnPlotMakeFile(gp, "Shock_compare_copvar_freq2yr_dur1yr_span3_impact50.png")
