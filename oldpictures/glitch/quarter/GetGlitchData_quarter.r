...
if (nrow(dat.glitchall) > 0)
{
    ...
    dat.glitchspan1 <- data.frame(dat.glitchall[dat.glitchallcopies$glitchfreq>0
                        & dat.glitchall$glitchfreq==2500
                        & dat.glitchall$glitchmaxlife==1000
                        & dat.glitchall$glitchimpact==50
                        ,]
                        )
    gp <- fnPlotGlitch1(dat.glitchspan1, nFreq=2500, nDuration=1000, nSpan=1, nImpact=50)
    plot(gp)
    fnPlotMakeFile(gp, "Glitch_compare_copvar_freq3mo_dur1mo_span1_impact50.png")
    ...
    dat.glitchspan1 <- dat.glitchall[dat.glitchall$glitchdecay==0
                        ...
                        ,]
    gp <- fnPlotGlitch1(dat.glitchspan1, nFreq=2500, nDuration=1000, nSpan=1, nImpact=33)
    plot(gp)
    fnPlotMakeFile(gp, "Glitch_compare_copvar_freq3mo_dur1mo_span1_impact33.png")
    ...
    dat.glitchspan1 <- dat.glitchall[dat.glitchall$glitchdecay==0
                        ...
                        ,]
    gp <- fnPlotGlitch1(dat.glitchspan1, nFreq=2500, nDuration=1000, nSpan=1, nImpact=67)
    plot(gp)
    fnPlotMakeFile(gp, "Glitch_compare_copvar_freq3mo_dur1mo_span1_impact67.png")
