# GetShockSpan2Server8Seg4Data.r
...
# P A R A M S
sPlotFile <- "shockspan2server8Seg4.png"
...
fnSubset <- function(dfIn)  {subset(dfIn, serverdefaultlife==80000
                                    & copies>=6
                                    & auditsegments==4
                                    )}
...
sTitleLine <-   (   ""
                %+% "Shocks: span=2; ServerDefaultHalflife=8yrs; "
                %+% "samples=5000 "
                %+% " "
                 %+% "\n"
