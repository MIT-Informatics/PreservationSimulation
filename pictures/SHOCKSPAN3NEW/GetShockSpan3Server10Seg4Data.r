# GetShockSpan3Server10Seg4Data.r
...
# P A R A M S
sPlotFile <- "shockspan3server10Seg4.png"
...
fnSubset <- function(dfIn)  {subset(dfIn, serverdefaultlife==100000
                                    & copies>=7
                                    & auditsegments==4
                                    )}
...
sTitleLine <-   (   ""
                %+% "Shocks: span=3; ServerDefaultHalflife=10yrs; "
                %+% "samples=5000 "
                %+% " "
                %+% "\n"
