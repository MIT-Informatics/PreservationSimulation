# GetShockSpan1Server4Seg10Data.r
...
# P A R A M S
sPlotFile <- "shockspan1server4Seg10.png"
...
sTitleLine <-   (   ""
                %+% "Shocks: span=1; ServerDefaultHalflife=4yrs; "
                %+% "samples=1000 "
                %+% " "
                %+% "\n"
                %+% "\n(Copies=5,6; annual systematic auditing in 10 segments)"
                )
